          ...
          >
            ...
            <div className="px-8 py-6 border-b border-gray-100 flex justify-between items-center bg-gradient-to-r from-brand-900 to-brand-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-serif text-white">თანამშრომლის მოწვევა</h3>
            ...
            <div className="p-8">
              {success ? (
                ...
                >
                  ...
                  <h4 className="text-xl font-serif text-brand-900 mb-2">მოწვევა გაიგზავნა!</h4>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    <label className="block text-xs font-bold text-brand-400 tracking-widest uppercase mb-2">
                      ელ. ფოსტა
                    </label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-gold-400 focus:bg-white focus:ring-4 focus:ring-gold-400/10 transition-all"
                      />
                    </div>
                  </div>
                      ...
                      <button
                        ...
                        className={`p-4 rounded-xl border-2 text-center transition-all cursor-pointer outline-none ${
                          selectedRole === 'consultant'
                            ...
                            : 'border-gray-200 bg-gray-50 text-brand-400 hover:border-gray-300'
                        }`}
                      >
                  ...
                  <div className="bg-brand-50/50 p-4 rounded-xl border border-brand-100/50">
                    <p className="text-xs text-brand-600 leading-relaxed">
                      ...
                      <span className="font-bold text-brand-900"> „{selectedRole === 'consultant' ? 'კონსულტანტის' : 'ბუღალტერის'}"</span> როლი.
                    </p>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-4 bg-brand-900 text-gold-400 rounded-xl uppercase tracking-widest font-bold text-sm hover:bg-brand-950 shadow-xl shadow-brand-900/20 disabled:opacity-60 disabled:cursor-not-allowed transition-all hover:-translate-y-0.5 outline-none border-none cursor-pointer flex items-center justify-center gap-2"
                  >
                    {isSubmitting ? (
                      <>
