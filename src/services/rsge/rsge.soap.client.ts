...
export const RSGE_CONFIG = {
  ...
  CREDENTIALS: {
    username: (typeof process !== 'undefined' ? process.env.VITE_RSGE_USERNAME : (import.meta as any).env.VITE_RSGE_USERNAME) ?? '',
    password: (typeof process !== 'undefined' ? process.env.VITE_RSGE_PASSWORD : (import.meta as any).env.VITE_RSGE_PASSWORD) ?? '',
    tin:      (typeof process !== 'undefined' ? process.env.VITE_RSGE_TIN : (import.meta as any).env.VITE_RSGE_TIN)      ?? '',
  } as RSGeCredentials,
